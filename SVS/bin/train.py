...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-save-dir", help="output directory which model file will be saved in."
    )
    parser.add_argument(
        "--model-type",
    ...
    parser.add_argument(
        "--max-epochs", default=20, type=int, help="Max. number of epochs to train"
    )
    ...
    parser.add_argument(
        "--num-frames", default=100, type=int, help="number of frames in one utterance"
    )
    parser.add_argument(
