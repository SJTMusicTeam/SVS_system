...
mv ${data}/alignment/0057* ${data}/alignment/${test}
...
mv ${data}/pitch_beat_extraction/57 ${data}/pitch_beat_extraction/${test}/
mv ${data}/pitch_beat_extraction/{1..56} ${data}/pitch_beat_extraction/${train}/
...
mv ${data}/wav_info/57 ${data}/wav_info/${test}/
mv ${data}/wav_info/{1..56} ${data}/wav_info/${train}/
