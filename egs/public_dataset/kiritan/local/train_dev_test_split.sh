...
# process pw_paras
mkdir -p ${data}/pw_paras/${dev}
mkdir -p ${data}/pw_paras/${test}
mkdir -p ${data}/pw_paras/${train}
mv ${data}/pw_paras/1 ${data}/pw_paras/${dev}/
mv ${data}/pw_paras/2 ${data}/pw_paras/${test}/
mv ${data}/pw_paras/{3..51} ${data}/pw_paras/${train}/
