...
mv ${data}/alignment/0055* ${data}/alignment/${dev}
mv ${data}/alignment/0056* ${data}/alignment/${test}
...
mv ${data}/pitch_beat_extraction/55 ${data}/pitch_beat_extraction/${dev}/
mv ${data}/pitch_beat_extraction/56 ${data}/pitch_beat_extraction/${test}/
mv ${data}/pitch_beat_extraction/{1..54} ${data}/pitch_beat_extraction/${train}/

# process wav split
mkdir -p ${data}/wav_info/${dev}
mkdir -p ${data}/wav_info/${test}
mkdir -p ${data}/wav_info/${train}
mv ${data}/wav_info/55 ${data}/wav_info/${dev}/
mv ${data}/wav_info/56 ${data}/wav_info/${test}/
mv ${data}/wav_info/{1..54} ${data}/wav_info/${train}/
