...
mv ${data}/alignment/0029* ${data}/alignment/${dev}
mv ${data}/alignment/0001* ${data}/alignment/${test}
...
mv ${data}/pitch_beat_extraction/1 ${data}/pitch_beat_extraction/${test}/
mv ${data}/pitch_beat_extraction/{2..31} ${data}/pitch_beat_extraction/${train}/
...
mv ${data}/wav_info/1 ${data}/wav_info/${test}/
mv ${data}/wav_info/{2..31} ${data}/wav_info/${train}/
